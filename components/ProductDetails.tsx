...
export default function ProductDetails({ id }: { id: string }) {
  ...
  const handleAddToCart = () => {
    console.log(`Added ${quantity} of product ${id} in color ${selectedColor} to cart`)
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8">
      ...
      <div className="lg:w-1/3">
        ...
        <p className="text-3xl font-semibold mb-6 text-purple-600">${product.price}</p>
        <div className="mb-6">
        ...
        <div className="flex gap-4 mb-8">
          <Button onClick={handleAddToCart} size="lg" className="flex-1 bg-purple-600 hover:bg-purple-700">
